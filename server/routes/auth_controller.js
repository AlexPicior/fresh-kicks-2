...
createAccount = async (req, res) =>{
    try{
        ...
        pool.query("INSERT INTO accounts (first_name, last_name, email, password, is_admin) VALUES ($1, $2, $3, $4, FALSE)", [firstName, lastName, email, hashedPassword], async (error, result) => {
